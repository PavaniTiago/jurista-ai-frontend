            ...
            <Card className="rounded-2xl">
              ...
              <CardContent className="space-y-3 overflow-visible">
                ...
                <Button
                  ...
                  className="w-full text-destructive rounded-xl hover:bg-destructive/10"
              ...
              <CardContent className="flex-1 flex flex-col p-4 md:p-6 min-h-0 overflow-hidden">
                <ScrollArea className="flex-1 min-h-0 pr-2 md:pr-4">
                  <div className="space-y-4 md:space-y-6 pb-4">
                    ...
                    {queryLoading && (
                      <TypingIndicator message="Consultando jurisprudência..." />
                    )}
                ...
                <div className="shrink-0 pt-4 space-y-4">
                  ...
                  <ChatInput
                    ...
                    disabled={queryLoading || document.status !== "completed"}
                    placeholder={
